...
@if(count($vacantes) > 0)
            ...
            <tbody class="bg-white">
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-sm leading-5 text-gray-500">Category:{{$vacante->categoria->nombre}}  </div>
                    </div>
                    </div>
                </td>
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500">
                    <a 
                        href="{{route('candidato.index',['id' => $vacante->id])}}" 
    ...
    {{$vacantes->links()}}
@else
    <p class="text-center mt-10 text-gray-700">You dont have any vacant</p>
@endif
