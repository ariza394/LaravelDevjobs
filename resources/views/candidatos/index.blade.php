...
@endsection
@section('content')
    <h1 class="text-2xl text-center mt-10">Candidates: {{$vacante->titulo}}</h1>
        ...
        <ul class="max-w-md mx-auto mt-10">
            @foreach($vacante->candidatos as $candidato)
                <li class="p-5 border border-gray-400 mb-5">
                    <p class="mb-4 ">
                        Name: <span class="font-bold">{{$candidato->nombre}}</span>
                    </p>
                    <p class="mb-4 ">
    ...
    @else
        <p class="text-center mt-5">This Application Does Not Have Candidates</p>
    @endif
@endsection